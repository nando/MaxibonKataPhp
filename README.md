...
# Kata Maxibon for Php. [![Build Status](https://travis-ci.org/nando/MaxibonKataPhp.svg?branch=master)](https://travis-ci.org/nando/MaxibonKataPhp)

- We are here to practice [property based testing][property-based-testing].
- We are going to use [Eris][eris] to write our tests.
...
Your task as PHP Developer is to resolve this problem or test an already implemented software, depending on the path you have choosen before to start.
...
* If you don not want to follow the TDD path create an empty project, add the [Eris][eris] library as a dependency and start writing code. 
